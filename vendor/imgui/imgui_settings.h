...
inline namespace c
{
	...
	inline ImColor background_color = rgba(20, 20, 20, 0.5F);
	inline ImColor stroke_color(255, 255, 255, 0);
	inline ImColor window_bg_color = rgba(22, 22, 22, 1.0F);
	...
	{
		inline float animation_speed;
		inline ImColor active(114, 149, 255, 255);
		inline ImColor default_color(22, 23, 26, 255);
	}

	inline namespace bg
	{
		inline ImVec4 background = rgba(22, 22, 22, 0.71F);
		inline ImVec2 background_size = ImVec2(850, 596);
		inline float rounding = 15.f;
	}

	inline namespace child
	{
		inline ImVec4 background = rgba(60, 60, 60, 0.25F);
	...
	inline namespace text
	{
		...
		inline namespace description
		{
			...
			inline ImColor default_color = ImColor(200, 200, 200, 40);
		}
