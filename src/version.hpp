...
#define VANTA_VERSION_MINOR 0
#define VANTA_VERSION_PATCH 1
...
#define VANTA_VERSION_STRING "1.0.1"
#define VANTA_VERSION_WSTRING L"1.0.1"
#define VANTA_VERSION_FILE_STRING "1.0.1.0"
